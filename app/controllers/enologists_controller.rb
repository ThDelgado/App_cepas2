class EnologistsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @enologist.save
        format.html { redirect_to enologist_url(@enologist), notice: "Enologist was successfully created." }
  ...
  def update
    respond_to do |format|
      if @enologist.update(enologist_params)
        format.html { redirect_to enologist_url(@enologist), notice: "Enologist was successfully updated." }
  ...
  private
    ...
    def enologist_params
      params.require(:enologist).permit(:type, :age, :nationality, :company, :user_id)
    end
end
